...
Para calibrar sua memória e focar na estratégia técnica (sem se perder em lixo de programação):
1. `docs/AmpAI_Consciencia_Do_Projeto.md` (Entendimento do que é a empresa e do Ecossistema).
2. `docs/AmpAI_Master_Roadmap_SaaS.md` (Qual a fase atual e o que devemos construir).
...
7. `docs/AmpAI_Protocolo_Operacional_CTO_CEO.md` (Roteamento, indicação de teste do CEO, `MERGE_VALIDADO`, `ENCERRAMENTO_OPERACIONAL` e ciclo de worktrees).
