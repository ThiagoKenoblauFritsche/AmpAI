...
*   **Separação multiprovedor:** Ciência e produto permanecem no Claude Code; Plataforma CI e DevOps/SRE operam em projetos Antigravity distintos; Codex preserva o Tribunal. A distribuição reduz concentração de franquia e falhas correlacionadas, mas não altera autoridades, escopos ou a Lei de Isolamento.
*   **Modelo não é autoridade:** Gemini 3.5 Flash é padrão operacional e Gemini 3.1 Pro High é escalonamento registrado. Trocar modelo não amplia permissões. Mudança de provedor/habitat é `CHG-3`; O.S. iniciada não muda de executor até o encerramento.
