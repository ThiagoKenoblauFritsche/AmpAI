...
- [x] **O.S. #039** | `[MÉDIA]` Branding: Refinamento do Header com Novo Logotipo. Utilizar a imagem provida como base para criar uma marca composta (Imagem + Tipografia) no Cabeçalho, adicionando os textos "AmpAI" e o subtítulo descritivo em um layout flexível e profissional.